...
export function CallToAction() {
  ...
  return (
    <section ref={ref} className="py-20 bg-magenta-500 text-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container relative">
        ...
        >
          ...
          >
            Join thousands of satisfied customers who trust DigiPrintPlus for their printing needs. 
            Get your instant quote today and experience the difference quality makes.
          </motion.p>
          ...
          >
            <p className="text-base">
              <strong>Rush Orders Available</strong> •  <strong>Expert Support</strong> •  <strong>Satisfaction Guaranteed</strong>
            </p>
          </motion.div>
        </motion.div>
      </div>
