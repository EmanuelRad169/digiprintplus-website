...
const slides = [
  ...
  },
  {
    ...
    description:
      "Eye-catching banners and signage that demand attention. Weather-resistant materials for indoor and outdoor use.",
    image:
  ...
  },
  {
    ...
    description:
      "From brochures to flyers, we help your brand stand out with professional marketing materials.",
    image:
