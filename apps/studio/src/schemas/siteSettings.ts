...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      description: 'The main title of your website (2-60 characters for SEO)'
    }),
    defineField({
      name: 'description',
      ...
      description: 'A brief description of your business (10-160 characters for meta description)'
    }),
    defineField({
      name: 'logo',
      title: 'Logo',
