...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  return {
    title: product.seo?.metaTitle || `${product.title} - DigiPrintPlus`,
    description: product.seo?.metaDescription || product.description || 'Professional printing services and solutions.',
