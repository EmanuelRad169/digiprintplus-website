...
// For example, if the file is at /Applications/MAMP/htdocs/FredCMs/apps/web/lib/sanity/contentFetchers.ts, use:
import type { AboutSection } from '../../lib/sanity/contentFetchers'
// Or, if you want to fix the alias, ensure your tsconfig.json has:
// "paths": { "@/*": ["./*"] }
