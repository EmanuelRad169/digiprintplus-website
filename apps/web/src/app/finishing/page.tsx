                ...
                <PortableText
                  ...
                  components={{
                    ...
                    block: {
                      ...
                      h1: ({ children }: any) => (
                        <h1 className="text-white font-bold mt-4 mb-2">
                          {children}
                        </h1>
                      ),
                      h2: ({ children }: any) => (
        ...
        <div className="container mx-auto px-4">
              ...
              {page.description ? (
                ...
                <div className="space-y-4 mb-8">
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Our state-of-the-art finishing department offers a
                    comprehensive range of post-press services to enhance your
                    printed materials. From simple binding to complex
                    die-cutting, we deliver professional results.
                  </p>
                  <p className="text-gray-600 text-lg leading-relaxed">
                    With advanced equipment and skilled technicians, we ensure
            ...
            <div>
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
                  Our Finishing{" "}
                  <span className="text-magenta-500">Services</span>
                </h2>
                <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                  Professional finishing options to complete your project with
                  excellence
                </p>
              </div>
                    ...
                    >
                      <div className="text-center">
                        {service.image?.asset?.url ? (
                          <div className="mb-4 mx-auto max-w-full">
                            <div className="relative w-full aspect-[3/1] overflow-hidden rounded-lg">
                              <Image
                                src={service.image.asset.url}
                                alt={service.image.alt || service.serviceName}
                                fill
                                className="object-cover"
                              />
                            </div>
          ...
          <div className="p-8 lg:p-16 my-6">
            <div className="text-center mb-10">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-4 leading-tight">
                Why Choose Our{" "}
                <span className="text-magenta-500">Finishing</span>
              </h2>
              <p className="text-gray-600 text-lg max-w-4xl mx-auto">
                Advanced technology, skilled craftsmanship, and attention to
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  State-of-the-art finishing equipment ensures precision and
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Our experienced team brings years of expertise to handle
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Efficient processes and workflow optimization deliver your
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generateSEO({
    ...
    description:
      ...
      "Professional finishing services to complete your printing projects with quality and precision.",
    canonical: "/finishing",
  });
}
