...
import { ArrowRight, Star, Search, Download, Eye, ChevronDown, Zap, Crown, Users } from 'lucide-react'
import { 
...
export default function TemplatesPageClient({ 
  ...
  const filteredTemplates = templates.filter(template => {
    ...
    const matchesFormat = selectedFormat === 'All Formats' || template.fileType === selectedFormat
