        ...
        <div className="container mx-auto px-4 py-14 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed mb-8 max-w-2xl">
              {pageData?.subtitle ||
                "From concept to completion, our comprehensive printing services deliver quality results for businesses of all sizes."}
            </p>
      ...
      <div className="py-16 lg:py-24">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <div className="inline-flex items-center bg-yellow-300 text-black px-3 py-2 rounded-full text-sm font-semibold mb-6">
              ...
              {!pageData?.content && (
                <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                  ...
                  DigiPrintPlus delivers exceptional quality and service for
                  businesses of all sizes. From business cards to large format
                  displays, we&apos;re your one-stop shop for all printing
                  needs.
                </p>
              )}
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              From concept to completion, we offer comprehensive printing
              services with the latest technology and expertise
            </p>
          </div>
          ...
          {/* Process Section */}
          <div className=" rounded-3xl p-8 lg:p-16 mb-20">
              ...
              {[
                {
                  ...
                  description:
                    "Share your files or ideas with our design team for a free consultation",
                },
                {
                  step: "02",
                  title: "Review & Approve",
                  description:
                    "We'll provide a detailed quote and proof for your review and approval",
                },
                {
                  step: "03",
                  title: "Print & Quality Check",
                  description:
                    "Our state-of-the-art equipment produces your order with rigorous quality control",
                },
                {
                  step: "04",
                  title: "Ship & Deliver",
                  description:
                    "Fast, secure delivery to your location with tracking information provided",
                },
              ].map((step, index) => (
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-10">
            <div className="lg:col-span-1">
              ...
              <Link
                href="/testimonials"
                className="inline-flex items-center text-magenta-600 font-semibold hover:text-magenta-700"
              >
            ...
            <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
              {[
                {
                  quote:
                    "DigiPrintPlus consistently delivers exceptional quality on tight deadlines. Their attention to detail and customer service is unmatched.",
                  author: "Sarah Johnson",
                  company: "Marketing Director, TechStart Inc.",
                },
                {
                  quote:
                    "From business cards to trade show displays, they handle all our printing needs. The team is professional and the results are always outstanding.",
                  author: "Michael Chen",
