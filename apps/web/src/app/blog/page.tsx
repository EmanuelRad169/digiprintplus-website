...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Stay updated with the latest trends, tips, and best practices in professional printing and design. Expert insights from the DigiPrintPlus team.",
    keywords:
      "printing blog, print industry, design tips, printing trends, business printing, custom printing, print solutions, DigiPrintPlus insights",
