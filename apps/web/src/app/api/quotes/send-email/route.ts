...
export async function POST(req: NextRequest) {
  try {
    ...
    const emailData = {
      ...
      content: emailContent || generateDefaultEmailContent(quote),
...
function generateDefaultEmailContent(quote: any): string {
...
For questions, contact us at info@digiprintplus.com or call (800) 555-1234.
`
}
