...
// ⚠️ DEPRECATED: This component is no longer used in the product detail pages
// The tab functionality has been removed in favor of a scrollable layout
// for better UX. All content is now displayed directly in the product page.
          ...
          {product.template?.hasTemplate ? (
                ...
                <div className="mt-8" id="preview">
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: product.template.htmlEmbed,
                    }}
                  />
                </div>
              )}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                A template for this product is not yet available. Contact us for
        ...
        <div className="space-y-6">
          {product.faq && product.faq.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Frequently asked questions for this product are not yet
                available. Contact us if you have specific questions.
              </p>
            </div>
          )}
        </div>
        ...
        <div className="space-y-6">
          {product.templates && product.templates.length > 0 ? (
                    ...
                    <div key={categoryTitle}>
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-sm text-gray-500 ml-4">
                          {templatesByCategory[categoryTitle].length} template
                          {templatesByCategory[categoryTitle].length !== 1
                            ? "s"
                            : ""}
                        </span>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {templatesByCategory[categoryTitle].map(
                          (template: Template) => (
                            <TemplateCard
                              key={template._id}
                              template={template}
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 max-w-md mx-auto leading-relaxed">
                No templates are currently available for this product. Please
