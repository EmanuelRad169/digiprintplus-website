...
export function JobSpecsStep({ formData, updateFormData }: JobSpecsStepProps) {
  ...
  const fallbackSettings = {
    jobSpecsStep: {
      ...
      productTypes: ['Business Cards', 'Brochures', 'Banners', 'Flyers', 'Posters', 'Stickers', 'Letterheads', 'Other'],
      quantities: ['100', '250', '500', '1,000', '2,500', '5,000', '10,000+', 'Custom'],
      paperTypes: ['Standard (80lb Text)', 'Premium (100lb Text)', 'Cardstock (14pt)', 'Heavy Cardstock (16pt)', 'Ultra Thick (32pt)', 'Vinyl', 'Canvas', 'Other'],
      finishes: ['None', 'Matte Finish', 'Gloss Finish', 'UV Coating', 'Lamination', 'Embossing', 'Foil Stamping', 'Die Cutting'],
      turnaroundTimes: ['Standard (3-5 business days)', 'Rush (1-2 business days)', 'Same Day (24 hours)', 'No rush - best price']
    },
    labels: {
  ...
  return (
    ...
    >
      <div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">{settings.jobSpecsStep.title}</h2>
      ...
      <div className="bg-magenta-50 p-4 rounded-lg">
        <p className="text-sm text-magenta-800">
          <strong>Note:</strong> Final pricing may vary based on exact specifications and file requirements. We&apos;ll provide a detailed quote based on your inputs.
        </p>
      </div>
    </motion.div>
  )
