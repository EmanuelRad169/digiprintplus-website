...
export function ReviewStep({ formData, updateFormData }: ReviewStepProps) {
  ...
  const fallbackSettings = {
    reviewStep: {
      ...
      terms:
        "I agree to the Terms of Service and Privacy Policy. I understand that this is a quote request and not a final order.",
    },
    buttonText: {
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        {formData.files.length > 0 ? (
          ...
          <p className="text-gray-500 text-sm">
            No files uploaded - design assistance requested
          </p>
        )}
      </div>
