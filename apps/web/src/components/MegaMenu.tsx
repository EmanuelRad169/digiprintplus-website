                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-white text-xs mt-1 max-w-md opacity-90">
                      ...
                      help you create custom printing solutions tailored to your
                      specific needs.
                    </div>
                  </div>
                </div>
...
function getIconNameFromText(text: string): string | null {
  ...
  if (
    ...
    lowerText.includes("booklet") ||
    lowerText.includes("catalog")
  )
    return "file-text";
  if (lowerText.includes("calendar")) return "calendar";
  if (lowerText.includes("bookmark")) return "bookmark";
  if (lowerText.includes("announcement") || lowerText.includes("gift"))
    return "gift";
  if (lowerText.includes("counter") || lowerText.includes("display"))
    return "star";
  if (lowerText.includes("door") || lowerText.includes("hanger"))
    return "map-pin";
  if (lowerText.includes("flyer") || lowerText.includes("brochure"))
    return "file-image";
  if (lowerText.includes("ncr") || lowerText.includes("form"))
    return "clipboard";
