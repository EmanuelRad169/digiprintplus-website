...
async function createLegalPages() {
  try {
    ...
    const existingPrivacy = await client.fetch('*[_type == "page" && slug.current == "privacy"][0]')
    const existingTerms = await client.fetch('*[_type == "page" && slug.current == "terms"][0]')
    ...
    if (existingPrivacy) {
      ...
      const privacyPage = await client.create({
        ...
        seo: {
          ...
          metaDescription: 'Learn how DigiPrintPlus protects your privacy and handles your personal information. Comprehensive privacy policy for our printing services.'
        },
    ...
    if (existingTerms) {
      ...
      const termsPage = await client.create({
        ...
        seo: {
          ...
          metaDescription: 'Read our terms of service for DigiPrintPlus printing services. Understand your rights and responsibilities when using our services.'
        },
        publishedAt: new Date().toISOString()
      })
