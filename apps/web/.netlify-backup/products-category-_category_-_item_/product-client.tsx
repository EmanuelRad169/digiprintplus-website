...
function TabContent({ activeTab, product }: TabContentProps) {
  const demoTemplate = {
    ...
    htmlEmbed:
      '<div style="padding: 20px; border: 2px solid #e2e8f0; border-radius: 8px; background: #f8fafc;"><h3>Sample Template Preview</h3><p>This is a preview of the template content.</p></div>',
  };
        ...
        <div className="space-y-6">
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: product.template?.htmlEmbed || demoTemplate.htmlEmbed,
            }}
          />
        </div>
      );
    ...
    case "details":
      return (
        <div className="prose max-w-none">
          <p>
            Our premium business cards are perfect for making a lasting
            impression.
          </p>
          <ul>
...
export default function ProductClient({ params }: ProductClientProps) {
  ...
  const [categoryData, setCategoryData] = useState<ProductCategory | null>(
    null,
  );
